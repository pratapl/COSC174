...
-------------------------------------------------------------------------
INSTRUCTIONS 
The files related to the final model(matrix factorization) are named MFxxxx.m and can be found in the folder finalModel. 
Initialize - use one of the following files. 
...
Run - use one of the following files
...
files from earlier models can be found in olderModels folder. 
	cross_validation: takes train set X and fold size N
